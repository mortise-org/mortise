<script lang="ts">
	...
	const extensions: Extension[] = [
		...
		},
		{
			...
			category: 'Infrastructure',
			action: 'https://github.com/mortise-org/mortise/blob/main/docs/recipes/monitoring.md',
			actionLabel: 'Recipe'
		},
		{
			...
			category: 'Security',
			action: 'https://github.com/mortise-org/mortise/blob/main/docs/recipes/external-secrets.md',
			actionLabel: 'Recipe'
		},
		{
			name: 'OPA Gatekeeper',
		...
		},
		{
			...
			category: 'Security',
			action: 'https://github.com/mortise-org/mortise/blob/main/docs/recipes/oidc.md',
			actionLabel: 'Recipe'
		},
		{
			name: 'cf-for-saas',
