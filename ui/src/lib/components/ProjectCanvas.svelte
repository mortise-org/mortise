...
<div class="h-full w-full">
	{#if apps.length === 0}
		<div class="flex h-full flex-col items-center justify-center gap-4 text-center">
			<div class="flex h-14 w-14 items-center justify-center rounded-full bg-surface-800 text-white">
	...
	{:else}
		<SvelteFlow
			...
			colorMode="dark"
		>
			<Background variant={BackgroundVariant.Dots} gap={20} size={1.6} patternColor="#555566" bgColor="#0A0F0A" />
			<Controls />
		</SvelteFlow>
	{/if}
