...
<div
	role="button"
	tabindex="0"
	class="relative flex w-60 flex-col gap-2 rounded-lg border bg-surface-800 p-3 transition-all duration-150 hover:shadow-lg hover:shadow-black/20 hover:border-surface-500 cursor-pointer {isExternal ? 'border-dashed border-surface-600' : 'border-surface-600'}"
