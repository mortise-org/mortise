...
**YOU ARE IN: `mortise/polecats/pipboy/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/pipboy
```
...
**Your mail address:** `mortise/polecats/pipboy`
**Your rig:** mortise
...
1. Announce: "Polecat pipboy, checking in."
