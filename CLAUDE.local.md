...
**YOU ARE IN: `mortise/polecats/scavenger/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mortise/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/scavenger
```
...
**Your mail address:** `mortise/polecats/scavenger`
**Your rig:** mortise
**Your Witness:** `mortise/witness`
...
1. Announce: "Polecat scavenger, checking in."
...
| Ask Witness for help | `gt mail send mortise/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mortise/witness`) when:
...
```bash
gt mail send mortise/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
